...
if ProductCategory.all.count == 0
  category1 = ProductCategory.create(name: "文豪具")
  category2 = ProductCategory.create(name: "果物")
  category3 = ProductCategory.create(name: "本")

  Product.create(name: "消しゴム", price: 100, product_category: category1)
  Product.create(name: "りんご", price: 200, product_category: category2)
  Product.create(name: "経済学入門書", price: 200, product_category: category3)
end
